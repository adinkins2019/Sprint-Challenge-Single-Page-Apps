...
> Answer: The benefits of client side routing is that pages are not refresh to display new data or information
- [ ] What does AJAX stand for? 
> Answer: Asynchronous JavaScript and XML
- [ ] What are `controlled components` in React? 
> Answer: Elements that have their form data information handled by React components rather than by the DOM
